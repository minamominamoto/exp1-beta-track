# Exp 1 β Pre-registration v1.2 — Frame Reversion in Instruction-Tuned LLMs
...
- **Version**: v1.2 (post-registration update; v1.1 archived at OSF as frozen)
...
| Item | Value |
|---|---|
| Pre-registration version | v1.2 (current; v1.1 archived at OSF) |
| Pre-registration commit hash (v1.1, recorded at OSF registration) | `3fdc049` (papers-under-review-/exp1-beta-track/, 2026-05-18) |
| Pre-registration commit hash (v1.2, Stage A2) | (recorded at the v1.2 GitHub commit) |
...
### 13.6 Stage 1 Pilot results (to be filled after pilot run on 2026-05-18)
- C1a-i: r(Family A) = TBD
- C1a-ii: r(Family A) = TBD
- C1a-iii: r(Family A) = TBD
- Adopted variant: TBD (per §5.3 selection rule)
- (This subsection is filled and committed before the main run; the adopted variant fixes the C1a content for the entire confirmatory analysis.)
