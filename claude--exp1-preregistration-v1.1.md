# Exp 1 β Pre-registration v1.1 — Frame Reversion in Instruction-Tuned LLMs

**Submitted**: 2026-05-18(fast-track; OSF DOI and GitHub commit hash inserted at submission)
**Author**: みなもと みなも(Minamo Minamoto)
**ORCID**: 0009-0002-1201-5704
**OSF**: [DOI to be assigned at submission]
**GitHub**: [repo URL + commit hash to be inserted at submission]
...
(The 6 SHAs above are confirmed values for this pre-registration. The SHA of this document itself is recorded via the GitHub commit hash at submission; once committed, modifications would create a new version v1.2 or later.)
...
| Item | Value |
|---|---|
| Pre-registration version | v1.1 |
| Pre-registration commit hash | [recorded at GitHub commit, 2026-05-18] |
| OSF DOI | [recorded at OSF submit, 2026-05-18] |
...
If any of the 6 companion files is modified after this pre-registration is committed to OSF, the modification is a deviation and reported in the manuscript. The SHA of this pre-registration document (v1.1) is fixed by its GitHub commit; any further modification produces a new version (v1.2 or later) with a new commit hash, which is reported as a deviation.
