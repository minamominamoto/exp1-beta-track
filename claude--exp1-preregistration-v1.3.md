# Exp 1 β Pre-registration v1.3 — Frame Reversion in Instruction-Tuned LLMs
...
- **Version**: v1.3 (Step C complete; v1.1 archived at OSF as frozen)
...
| Item | Value |
|---|---|
| Pre-registration version | v1.3 (current; v1.1 archived at OSF) |
...
| Pre-registration commit hash (v1.3, Stage C) | (recorded at the v1.3 GitHub commit) |
...
- `stage1_pilot_20260518_094625.json` (pilot results JSON; SHA256: [to be filled after `modal volume get`])
- `logs/stage1_20260518_094625.log` (run log; SHA256: [to be filled after `modal volume get`])
